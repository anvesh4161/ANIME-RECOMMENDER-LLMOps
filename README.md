...
- **Clone your GitHub repo**
  ...
  ```bash
  git clone https://github.com/anvesh4161/ANIME-RECOMMENDER-LLMOps.git
  ls
  cd TESTING-9
...
```bash
git config --global user.email "anveshbunty01@gmail.com"
git config --global user.name "anvesh4161"
